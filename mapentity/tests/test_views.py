...
class ConvertTest(BaseTest):
    ...
    def test_convert_view_uses_original_request_headers(self, get_mocked):
        ...
        get_mocked.assert_called_with('http://127.0.0.1:6543/?url=http%3A//geotrek.fr&to=application/pdf',
    ...
    def test_convert_view_builds_absolute_url_from_relative(self, get_mocked):
        ...
        get_mocked.assert_called_with('http://127.0.0.1:6543/?url=http%3A//testserver/path/1/&to=application/pdf',
                                      headers={})
