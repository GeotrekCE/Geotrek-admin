...
messages:
	$(docker_compose) run --rm web ./manage.py makemessages -a --no-location --no-obsolete --no-wrap --ignore var/cache --ignore var/frontend --ignore frontend --ignore cypress
	$(docker_compose) run --rm web ./manage.py makemessages -a --no-location --no-obsolete --no-wrap -d djangojs --ignore var/cache --ignore var/frontend --ignore frontend --ignore cypress
