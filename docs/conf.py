...
latex_documents = [
    ('index', 'Geotrek.tex', u'Geotrek Documentation',
...
man_pages = [
    ('index', 'geotrek', u'Geotrek Documentation',
     [u'Makina Corpus'], 1)
]
...
texinfo_documents = [
    ('index', 'Geotrek', u'Geotrek Documentation',
     u'Makina Corpus', 'Geotrek', 'One line description of project.',
     'Miscellaneous'),
]
