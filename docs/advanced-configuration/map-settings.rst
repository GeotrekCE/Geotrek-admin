...
In a shell prompt, run the following commands:

.. md-tab-set::
    :name: pgrouting-tolerance-regenerate-network-tabs

    .. md-tab-item:: With Debian

        .. code-block:: bash

            sudo geotrek shell -c "from geotrek.core.models import Path; Path.objects.all().update(source_pgr=None, target_pgr=None)"
    ...
    .. md-tab-item:: With Docker
        ...
        .. code-block:: bash
            ...
            docker compose run --rm web ./manage.py shell -c "from geotrek.core.models import Path; Path.objects.all().update(source_pgr=None, target_pgr=None)"
