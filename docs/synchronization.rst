...
::
    ...
    ./manage.py sync_rando /where/to/generate/data
...
::
    ...
    0 3 * * * root /path/to/geotrek/manage.py sync_rando /where/to/generate/data
...
::
    ...
    ./manage.py sync_rando --source "source A,source B" dataAB
...
::
    ...
    ./manage.py sync_rando --portal "portal A" dataA
...
::
    ...
    ./manage.py sync_rando --with-touristiccontent-categories="1,3"
