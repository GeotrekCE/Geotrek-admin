...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('chantiers', 'update_date')

        # Deleting field 'Project.insert_date'
        db.delete_column('chantiers', 'insert_date')

        # Adding field 'Project.date_insert'
        db.add_column('chantiers', 'date_insert',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Project.date_update'
        db.add_column('chantiers', 'date_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.update_date'
        db.add_column('chantiers', 'update_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Project.insert_date'
        db.add_column('chantiers', 'insert_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 13, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Project.date_insert'
        db.delete_column('chantiers', 'date_insert')

        # Deleting field 'Project.date_update'
        db.delete_column('chantiers', 'date_update')
