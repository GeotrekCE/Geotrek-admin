...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Funding.structure'
        db.delete_column('financement', 'structure_id')


    def backwards(self, orm):
        # Adding field 'Funding.structure'
        db.add_column('financement', 'structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['authent.Structure']),
                      keep_default=False)
