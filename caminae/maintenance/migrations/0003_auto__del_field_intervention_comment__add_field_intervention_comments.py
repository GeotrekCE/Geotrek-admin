...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Intervention.comment'
        db.delete_column('interventions', 'comment')

        # Adding field 'Intervention.comments'
        db.add_column('interventions', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Intervention.comment'
        db.add_column('interventions', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Intervention.comments'
        db.delete_column('interventions', 'comments')
