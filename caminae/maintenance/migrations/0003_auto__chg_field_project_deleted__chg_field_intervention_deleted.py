...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Project.deleted' to match new field type.
        db.rename_column('chantiers', 'deleted', 'supprime')
        # Changing field 'Project.deleted'
        db.alter_column('chantiers', 'supprime', self.gf('django.db.models.fields.BooleanField')(db_column='supprime'))

        # Renaming column for 'Intervention.deleted' to match new field type.
        db.rename_column('interventions', 'deleted', 'supprime')
        # Changing field 'Intervention.deleted'
        db.alter_column('interventions', 'supprime', self.gf('django.db.models.fields.BooleanField')(db_column='supprime'))

    def backwards(self, orm):

        # Renaming column for 'Project.deleted' to match new field type.
        db.rename_column('chantiers', 'supprime', 'deleted')
        # Changing field 'Project.deleted'
        db.alter_column('chantiers', 'deleted', self.gf('django.db.models.fields.BooleanField')())

        # Renaming column for 'Intervention.deleted' to match new field type.
        db.rename_column('interventions', 'supprime', 'deleted')
        # Changing field 'Intervention.deleted'
        db.alter_column('interventions', 'deleted', self.gf('django.db.models.fields.BooleanField')())
