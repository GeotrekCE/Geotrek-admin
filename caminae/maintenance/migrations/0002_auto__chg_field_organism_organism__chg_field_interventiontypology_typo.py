...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('liste_de_tous_les_organismes', 'organism', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'InterventionTypology.typology'
        db.alter_column('typologie_des_interventions', 'typology', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Contractor.contractor'
        db.alter_column('prestataires', 'contractor', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'InterventionStatus.status'
        db.alter_column('bib_de_suivi', 'status', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'InterventionJob.job'
        db.alter_column('bib_fonctions', 'job', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'InterventionDisorder.disorder'
        db.alter_column('desordres', 'disorder', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Organism.organism'
        db.alter_column('liste_de_tous_les_organismes', 'organism', self.gf('django.db.models.fields.TextField')(max_length=128))

        # Changing field 'InterventionTypology.typology'
        db.alter_column('typologie_des_interventions', 'typology', self.gf('django.db.models.fields.TextField')(max_length=128))

        # Changing field 'Contractor.contractor'
        db.alter_column('prestataires', 'contractor', self.gf('django.db.models.fields.TextField')(max_length=128))

        # Changing field 'InterventionStatus.status'
        db.alter_column('bib_de_suivi', 'status', self.gf('django.db.models.fields.TextField')(max_length=128))

        # Changing field 'InterventionJob.job'
        db.alter_column('bib_fonctions', 'job', self.gf('django.db.models.fields.TextField')(max_length=128))

        # Changing field 'InterventionDisorder.disorder'
        db.alter_column('desordres', 'disorder', self.gf('django.db.models.fields.TextField')(max_length=128))
