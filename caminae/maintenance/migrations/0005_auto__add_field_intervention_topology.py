...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Intervention.topology'
        db.add_column('interventions', 'topology',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='interventions', null=True, to=orm['core.TopologyMixin']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Intervention.topology'
        db.delete_column('interventions', 'topology_id')
