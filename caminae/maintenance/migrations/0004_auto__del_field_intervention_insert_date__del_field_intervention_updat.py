...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Intervention.insert_date'
        db.delete_column('interventions', 'insert_date')

        # Deleting field 'Intervention.update_date'
        db.delete_column('interventions', 'update_date')

        # Adding field 'Intervention.date_insert'
        db.add_column('interventions', 'date_insert',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Intervention.date_update'
        db.add_column('interventions', 'date_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 8, 8, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Intervention.insert_date'
        raise RuntimeError("Cannot reverse this migration. 'Intervention.insert_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Intervention.update_date'
        raise RuntimeError("Cannot reverse this migration. 'Intervention.update_date' and its values cannot be restored.")
        # Deleting field 'Intervention.date_insert'
        db.delete_column('interventions', 'date_insert')

        # Deleting field 'Intervention.date_update'
        db.delete_column('interventions', 'date_update')
