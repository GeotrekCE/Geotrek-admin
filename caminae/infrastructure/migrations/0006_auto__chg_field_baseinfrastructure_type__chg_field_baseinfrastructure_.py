...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'BaseInfrastructure.type' to match new field type.
        db.rename_column('a_t_amenagement', 'type_id', 'type')
        # Changing field 'BaseInfrastructure.type'
        db.alter_column('a_t_amenagement', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['infrastructure.InfrastructureType'], db_column='type'))

        # Changing field 'BaseInfrastructure.description'
        db.alter_column('a_t_amenagement', 'description', self.gf('django.db.models.fields.TextField')(db_column='description'))

    def backwards(self, orm):

        # Renaming column for 'BaseInfrastructure.type' to match new field type.
        db.rename_column('a_t_amenagement', 'type', 'type_id')
        # Changing field 'BaseInfrastructure.type'
        db.alter_column('a_t_amenagement', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['infrastructure.InfrastructureType']))

        # Changing field 'BaseInfrastructure.description'
        db.alter_column('a_t_amenagement', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'infrastructure.baseinfrastructure': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['infrastructure.InfrastructureType']", 'db_column': "'type'"})
        },
