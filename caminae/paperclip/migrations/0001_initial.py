...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('paperclip_attachment', (
            ...
            ('filetype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.FileType'])),
        ...
        db.send_create_signal('paperclip', ['Attachment'])


    def backwards(self, orm):
        # Deleting model 'Attachment'
        db.delete_table('paperclip_attachment')
    ...
    models = {
        ...
        'paperclip.attachment': {
            'Meta': {'ordering': "['-date_insert']", 'object_name': 'Attachment'},
            ...
            'filetype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.FileType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
