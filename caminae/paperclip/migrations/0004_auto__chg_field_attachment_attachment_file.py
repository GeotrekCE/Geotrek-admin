...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('fl_t_fichier', 'attachment_file', self.gf('django.db.models.fields.files.FileField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Attachment.attachment_file'
        db.alter_column('fl_t_fichier', 'attachment_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
