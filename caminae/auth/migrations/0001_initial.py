...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('auth_structure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('auth', ['Structure'])
        ...
        db.create_table('auth_userprofile', (
            ...
            ('structure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Structure'])),
        ))
        db.send_create_signal('auth', ['UserProfile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('auth_structure')
