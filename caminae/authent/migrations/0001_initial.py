...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('authent_structure', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('authent', ['Structure'])

        # Adding model 'UserProfile'
        db.create_table('authent_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('authent', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'Structure'
        db.delete_table('authent_structure')

        # Deleting model 'UserProfile'
        db.delete_table('authent_userprofile')
