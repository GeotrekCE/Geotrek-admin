...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bib_confort', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('structure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authent.Structure'])),
            ('comfort', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('core', ['Comfort'])

        # Adding field 'Path.comfort'
        db.add_column('troncons', 'comfort',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='paths', null=True, to=orm['core.Comfort']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Comfort'
        db.delete_table('bib_confort')

        # Deleting field 'Path.comfort'
        db.delete_column('troncons', 'comfort_id')
