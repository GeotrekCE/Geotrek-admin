...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PathAggregation.order'
        db.alter_column('e_r_evenement_troncon', 'ordre', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='ordre'))

    def backwards(self, orm):

        # Changing field 'PathAggregation.order'
        db.alter_column('e_r_evenement_troncon', 'ordre', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='ordre'))
