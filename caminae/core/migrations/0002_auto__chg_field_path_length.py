...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('troncons', 'longueur', self.gf('django.db.models.fields.FloatField')(db_column='longueur'))

    def backwards(self, orm):

        # Changing field 'Path.length'
        db.alter_column('troncons', 'longueur', self.gf('django.db.models.fields.IntegerField')(db_column='longueur'))
