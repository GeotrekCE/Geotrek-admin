...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PathAggregation.path'
        db.alter_column('evenements_troncons', 'troncon', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.DO_NOTHING, db_column='troncon', to=orm['core.Path']))

    def backwards(self, orm):

        # Changing field 'PathAggregation.path'
        db.alter_column('evenements_troncons', 'troncon', self.gf('django.db.models.fields.related.ForeignKey')(db_column='troncon', to=orm['core.Path']))
