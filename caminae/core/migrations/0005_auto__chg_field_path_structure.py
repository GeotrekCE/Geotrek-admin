...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('troncons', 'structure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authent.Structure']))

    def backwards(self, orm):

        # Changing field 'Path.structure'
        db.alter_column('troncons', 'structure_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Structure']))
