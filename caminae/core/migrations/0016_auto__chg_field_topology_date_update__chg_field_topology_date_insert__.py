...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('e_t_evenement', 'date_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_column='date_update'))

        # Changing field 'Topology.date_insert'
        db.alter_column('e_t_evenement', 'date_insert', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_column='date_insert'))

        # Changing field 'Path.date_update'
        db.alter_column('l_t_troncon', 'date_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_column='date_update'))

        # Changing field 'Path.date_insert'
        db.alter_column('l_t_troncon', 'date_insert', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_column='date_insert'))
