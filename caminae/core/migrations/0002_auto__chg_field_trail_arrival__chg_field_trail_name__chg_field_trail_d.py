...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sentier', 'arrival', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Trail.name'
        db.alter_column('sentier', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Trail.departure'
        db.alter_column('sentier', 'departure', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Trail.comments'
        db.alter_column('sentier', 'comments', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Trail.arrival'
        db.alter_column('sentier', 'arrival', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Trail.name'
        db.alter_column('sentier', 'name', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Trail.departure'
        db.alter_column('sentier', 'departure', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Trail.comments'
        db.alter_column('sentier', 'comments', self.gf('django.db.models.fields.CharField')(max_length=200))
