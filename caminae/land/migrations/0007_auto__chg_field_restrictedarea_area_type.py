...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'RestrictedArea.area_type' to match new field type.
        db.rename_column('l_zonage_reglementaire', 'area_type_id', 'type')
        # Changing field 'RestrictedArea.area_type'
        db.alter_column('l_zonage_reglementaire', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['land.RestrictedAreaType'], db_column='type'))

    def backwards(self, orm):

        # Renaming column for 'RestrictedArea.area_type' to match new field type.
        db.rename_column('l_zonage_reglementaire', 'type', 'area_type_id')
        # Changing field 'RestrictedArea.area_type'
        db.alter_column('l_zonage_reglementaire', 'area_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['land.RestrictedAreaType']))
