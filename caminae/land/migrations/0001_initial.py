...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('couche_zonage_reglementaire', (
            ...
            ('geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(spatial_index=False)),
        ))
    ...
    models = {
        ...
        'land.city': {
            ...
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'spatial_index': 'False'}),
