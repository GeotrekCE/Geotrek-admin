...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'POI.deleted'
        db.delete_column('trekking_poi', 'supprime')

        # Deleting field 'POI.id'
        db.delete_column('trekking_poi', 'id')

        # Deleting field 'POI.date_update'
        db.delete_column('trekking_poi', 'date_update')

        # Deleting field 'POI.date_insert'
        db.delete_column('trekking_poi', 'date_insert')

        # Adding field 'POI.topo_object'
        db.add_column('trekking_poi', 'topo_object',
    ...
    def backwards(self, orm):
        # Adding field 'POI.deleted'
        db.add_column('trekking_poi', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column='supprime'),
                      keep_default=False)

        # Adding field 'POI.id'
        db.add_column('trekking_poi', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Adding field 'POI.date_update'
        db.add_column('trekking_poi', 'date_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=0, blank=True),
                      keep_default=False)

        # Adding field 'POI.date_insert'
        db.add_column('trekking_poi', 'date_insert',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 14, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'POI.topo_object'
        db.delete_column('trekking_poi', 'evenement')
