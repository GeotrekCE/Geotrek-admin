...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebLinkCategory.label_en'
        db.add_column('o_t_web_category', 'label_en',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebLinkCategory.label_fr'
        db.add_column('o_t_web_category', 'label_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WebLinkCategory.label_it'
        db.add_column('o_t_web_category', 'label_it',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebLinkCategory.label_en'
        db.delete_column('o_t_web_category', 'label_en')

        # Deleting field 'WebLinkCategory.label_fr'
        db.delete_column('o_t_web_category', 'label_fr')

        # Deleting field 'WebLinkCategory.label_it'
        db.delete_column('o_t_web_category', 'label_it')
