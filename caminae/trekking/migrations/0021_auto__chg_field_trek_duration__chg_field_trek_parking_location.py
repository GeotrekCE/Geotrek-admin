...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('itineraire', 'parking_location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=2154, null=True, spatial_index=False))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Trek.parking_location'
        db.alter_column('itineraire', 'parking_location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=2154, default='POINT(0,0)', spatial_index=False))
