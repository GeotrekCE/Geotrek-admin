...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WebLink.thumbnail'
        db.alter_column('liens_web', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'WebLink.thumbnail'
        db.alter_column('liens_web', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))
    ...
    models = {
        ...
        'trekking.trek': {
            ...
            'main_themes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'treks_main'", 'symmetrical': 'False', 'to': "orm['trekking.Theme']"}),
