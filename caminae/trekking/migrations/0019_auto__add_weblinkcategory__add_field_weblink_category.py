...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('o_t_web_category', (
        ...
        db.send_create_signal('trekking', ['WebLinkCategory'])

        # Adding field 'WebLink.category'
        db.add_column('liens_web', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='links', null=True, to=orm['trekking.WebLinkCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'WebLinkCategory'
        db.delete_table('o_t_web_category')

        # Deleting field 'WebLink.category'
        db.delete_column('liens_web', 'category_id')
