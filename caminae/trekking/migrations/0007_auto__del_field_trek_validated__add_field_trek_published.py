...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trek.validated'
        db.delete_column('itineraire', 'validated')

        # Adding field 'Trek.published'
        db.add_column('itineraire', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Trek.validated'
        db.add_column('itineraire', 'validated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Trek.published'
        db.delete_column('itineraire', 'published')
