...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.label_en'
        db.add_column('trekking_theme', 'label_en',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Theme.label_fr'
        db.add_column('trekking_theme', 'label_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Theme.label_it'
        db.add_column('trekking_theme', 'label_it',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.label_en'
        db.delete_column('trekking_theme', 'label_en')

        # Deleting field 'Theme.label_fr'
        db.delete_column('trekking_theme', 'label_fr')

        # Deleting field 'Theme.label_it'
        db.delete_column('trekking_theme', 'label_it')
