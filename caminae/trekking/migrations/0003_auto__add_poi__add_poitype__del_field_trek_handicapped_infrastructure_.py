...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('trekking_poi', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pois', to=orm['trekking.POIType'])),
        ))
        db.send_create_signal('trekking', ['POI'])

        # Adding model 'POIType'
        db.create_table('trekking_poitype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('label_en', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('label_fr', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('label_it', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('pictogram', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('trekking', ['POIType'])

        # Deleting field 'Trek.handicapped_infrastructure'
        db.delete_column('itineraire', 'handicapped_infrastructure')
        ...
        # Adding field 'Trek.disabled_infrastructure'
        db.add_column('itineraire', 'disabled_infrastructure',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Trek.disabled_infrastructure_en'
        db.add_column('itineraire', 'disabled_infrastructure_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trek.disabled_infrastructure_fr'
        db.add_column('itineraire', 'disabled_infrastructure_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trek.disabled_infrastructure_it'
        db.add_column('itineraire', 'disabled_infrastructure_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'POI'
        db.delete_table('trekking_poi')

        # Deleting model 'POIType'
        db.delete_table('trekking_poitype')

        # Adding field 'Trek.handicapped_infrastructure'
        db.add_column('itineraire', 'handicapped_infrastructure',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)
        ...
        # Deleting field 'Trek.disabled_infrastructure'
        db.delete_column('itineraire', 'disabled_infrastructure')

        # Deleting field 'Trek.disabled_infrastructure_en'
        db.delete_column('itineraire', 'disabled_infrastructure_en')

        # Deleting field 'Trek.disabled_infrastructure_fr'
        db.delete_column('itineraire', 'disabled_infrastructure_fr')

        # Deleting field 'Trek.disabled_infrastructure_it'
        db.delete_column('itineraire', 'disabled_infrastructure_it')
