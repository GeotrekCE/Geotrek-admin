...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('o_b_usage', 'picto', self.gf('django.db.models.fields.files.FileField')(max_length=512, db_column='picto'))

        # Changing field 'Theme.pictogram'
        db.alter_column('o_b_theme', 'picto', self.gf('django.db.models.fields.files.FileField')(max_length=512, db_column='picto'))

        # Changing field 'WebLinkCategory.pictogram'
        db.alter_column('o_b_web_category', 'picto', self.gf('django.db.models.fields.files.FileField')(max_length=512, db_column='picto'))

        # Changing field 'POIType.pictogram'
        db.alter_column('o_b_poi', 'picto', self.gf('django.db.models.fields.files.FileField')(max_length=512, db_column='picto'))
