...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.access'
        db.add_column('itineraire', 'access',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Trek.access_en'
        db.add_column('itineraire', 'access_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trek.access_fr'
        db.add_column('itineraire', 'access_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trek.access_it'
        db.add_column('itineraire', 'access_it',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trek.access'
        db.delete_column('itineraire', 'access')

        # Deleting field 'Trek.access_en'
        db.delete_column('itineraire', 'access_en')

        # Deleting field 'Trek.access_fr'
        db.delete_column('itineraire', 'access_fr')

        # Deleting field 'Trek.access_it'
        db.delete_column('itineraire', 'access_it')
