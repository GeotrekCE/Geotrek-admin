...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.author'
        db.add_column('fl_t_fichier', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='auteur', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.author'
        db.delete_column('fl_t_fichier', 'auteur')
