...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='dive',
            name='advice',
            field=models.TextField(blank=True, help_text='Risques, danger, meilleure période, ...', verbose_name='Recommandation'),
        ),
        migrations.AlterField(
            model_name='dive',
            name='date_insert',
        ...
        migrations.AlterField(
            model_name='practice',
            name='color',
            field=colorfield.fields.ColorField(default='#444444', help_text="Couleur de la pratique, utilisé uniquement pour l'app mobile", max_length=18, verbose_name='Couleur'),
        ),
        migrations.AlterField(
            model_name='practice',
            name='pictogram',
