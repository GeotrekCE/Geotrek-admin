...
class SyncRandoTestCase(TestCase):
    ...
    def test_sync_detail_no_portal_no_source(self, stdout, mock_prepare):
        ...
        self.assertTrue(os.path.exists(os.path.join('var', command.tmp_root, 'api', 'fr', 'dives',
    ...
    def test_sync_language(self, stdout, mock_prepare):
        ...
        self.assertTrue(os.path.exists(os.path.join('var', command.tmp_root, 'api', 'en', 'dives.geojson')))
