...
class CityViewSet(api_viewsets.GeotrekViewset):
    ...
    serializer_detail_class = api_serializers.CitySerializer
    queryset = zoning_models.City.objects.all()


class DistrictViewSet(api_viewsets.GeotrekViewset):
    filter_backends = (DjangoFilterBackend,
                       api_filters.GeotrekQueryParamsFilter,
                       api_filters.GeotrekInBBoxFilter,
                       api_filters.GeotrekDistanceToPointFilter)
    serializer_class = api_serializers.DistrictsSerializer
    serializer_detail_class = api_serializers.DistrictsSerializer
