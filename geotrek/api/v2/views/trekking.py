...
class TrekViewSet(api_viewsets.GeotrekGeometricViewset):
            ...
            return (
                ...
                .prefetch_related(
                    ...
                    Prefetch(
                        ...
                        queryset=AccessibilityAttachment.objects.select_related(
                            "license"
                        ),
                    ),
                    Prefetch(
                        "web_links",
                        queryset=trekking_models.WebLink.objects.select_related(
                            "category"
                        ),
                    ),
                    Prefetch(
    ...
    def filter_published_lang_retrieve(self, request, queryset):
        ...
        associated_published_fields = [
            ...
            if f.name.startswith("published")
        ]
        ...
        if language == "all":
            ...
            for lang in settings.MODELTRANSLATION_LANGUAGES:
                ...
                if field_name in associated_published_fields:
                    field_name_parent = "trek_parents__parent__{}".format(
                        build_localized_fieldname("published", lang)
                    )
            ...
            field_name_parent = "trek_parents__parent__{}".format(
                build_localized_fieldname("published", language)
            )
...
class PracticeViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.PracticeSerializer(
...
class TrekRatingScaleViewSet(api_viewsets.GeotrekViewSet):
    ...
    queryset = trekking_models.RatingScale.objects.order_by(
        "pk"
    )  # Required for reliable pagination
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.TrekRatingScaleSerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class TrekRatingViewSet(api_viewsets.GeotrekViewSet):
    ...
    queryset = trekking_models.Rating.objects.order_by(
        "order", "name", "pk"
    )  # Required for reliable pagination
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.TrekRatingSerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class NetworkViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.NetworkSerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class DifficultyViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.TrekDifficultySerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class POIViewSet(api_viewsets.GeotrekGeometricViewset):
    ...
    queryset = (
        trekking_models.POI.objects.existing()
        .select_related(
            "topo_object",
            "type",
        )
...
class AccessibilityViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.AccessibilitySerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class AccessibilityLevelViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.AccessibilityLevelSerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class RouteViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.RouteSerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class ServiceTypeViewSet(api_viewsets.GeotrekViewSet):
    ...
    def retrieve(self, request, pk=None, format=None):
        ...
        serializer = api_serializers.ServiceTypeSerializer(
            elem, many=False, context={"request": request}
        )
        return Response(serializer.data)
...
class ServiceViewSet(api_viewsets.GeotrekGeometricViewset):
    ...
    queryset = (
        trekking_models.Service.objects.existing()
        .select_related(
            "topo_object",
            "type",
        )
