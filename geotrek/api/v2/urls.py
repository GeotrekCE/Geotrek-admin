...
if 'geotrek.feedback' in settings.INSTALLED_APPS:
    ...
    router.register('feedback_category', api_views.ReportCategoryViewSet, basename='category')
    router.register('feedback_activity', api_views.ReportActivityViewSet, basename='activity')
    router.register('feedback_magnitude', api_views.ReportProblemMagnitudeViewSet, basename='magnitude')
