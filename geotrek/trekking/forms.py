...
#         ]
#
# class OnNetworkTrekForm(BaseTrekForm, TopologyForm):
#
#     class Meta(BaseTrekForm.Meta, TopologyForm.Meta):
#         model = Trek
#
#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)
