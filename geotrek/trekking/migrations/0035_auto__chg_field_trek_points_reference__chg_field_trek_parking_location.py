...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'trekking.trek': {
            ...
            'source': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'treks'", 'blank': 'True', 'db_table': "'o_r_itineraire_portal'", 'to': u"orm['common.TargetPortal']"}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authent.Structure']", 'db_column': "'structure'"}),
