...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.review'
        db.add_column('o_t_itineraire', 'review',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column='relecture'),
                      keep_default=False)

        # Adding field 'POI.review'
        db.add_column('o_t_poi', 'review',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column='relecture'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trek.review'
        db.delete_column('o_t_itineraire', 'relecture')

        # Deleting field 'POI.review'
        db.delete_column('o_t_poi', 'relecture')
