...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.eid2'
        db.add_column('o_t_itineraire', 'eid2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe2', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trek.eid2'
        db.delete_column('o_t_itineraire', 'id_externe2')
