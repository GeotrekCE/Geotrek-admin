...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'POI.published'
        db.add_column('o_t_poi', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column='public'),
                      keep_default=False)

        # Adding field 'POI.publication_date'
        db.add_column('o_t_poi', 'publication_date',
    ...
    def backwards(self, orm):
        # Deleting field 'POI.published'
        db.delete_column('o_t_poi', 'public')
