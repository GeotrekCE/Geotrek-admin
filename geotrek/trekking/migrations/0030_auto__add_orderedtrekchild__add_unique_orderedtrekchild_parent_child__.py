...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderedTrekChild'
        db.create_table('o_r_itineraire_itineraire2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trek_children', to=orm['trekking.Trek'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trek_parents', to=orm['trekking.Trek'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'trekking', ['OrderedTrekChild'])
    ...
    models = {
        ...
        u'trekking.trek': {
            ...
            'children_trek': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['trekking.Trek']", 'symmetrical': 'False', 'through': u"orm['trekking.OrderedTrekChild']", 'blank': 'True'}),
            ...
            'parking_location': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': settings.SRID, 'null': 'True', 'spatial_index': 'False', 'db_column': "'geom_parking'", 'blank': 'True'}),
            'points_reference': ('django.contrib.gis.db.models.fields.MultiPointField', [], {'srid': settings.SRID, 'null': 'True', 'spatial_index': 'False', 'db_column': "'geom_points_reference'", 'blank': 'True'}),
