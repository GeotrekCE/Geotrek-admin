...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.distance'
        db.add_column('o_b_pratique', 'distance',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_column='distance', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Practice.distance'
        db.delete_column('o_b_pratique', 'distance')
