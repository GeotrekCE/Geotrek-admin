...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('itineraire_themes', 'o_r_itineraire_theme')
        db.rename_table('itineraire_networks', 'o_r_itineraire_reseau')
        db.rename_table('itineraire_usages', 'o_r_itineraire_usage')
        db.rename_table('itineraire_web_links', 'o_r_itineraire_web')
        db.rename_table('itineraire', 'o_t_itineraire')
        db.rename_table('liens_itineraire', 'o_r_itineraire_itineraire')
        db.rename_table('reseau', 'o_b_reseau')
        db.rename_table('usages', 'o_b_usage')
        db.rename_table('parcours', 'o_b_parcours')
        db.rename_table('classement_difficulte', 'o_b_difficulte')
        db.rename_table('liens_web', 'o_t_web')
        db.rename_table('o_t_web_category', 'o_b_web_category')
        db.rename_table('trekking_theme', 'o_b_theme')
        db.rename_table('trekking_poi', 'o_t_poi')
        db.rename_table('trekking_poitype', 'o_b_poi')

    def backwards(self, orm):
        db.rename_table('o_r_itineraire_theme', 'itineraire_themes')
        db.rename_table('o_r_itineraire_reseau', 'itineraire_networks')
        db.rename_table('o_r_itineraire_usage', 'itineraire_usages')
        db.rename_table('o_r_itineraire_web', 'itineraire_web_links')
        db.rename_table('o_t_itineraire', 'itineraire')
        db.rename_table('o_r_itineraire_itineraire', 'liens_itineraire')
        db.rename_table('o_b_reseau', 'reseau')
        db.rename_table('o_b_usage', 'usages')
        db.rename_table('o_b_parcours', 'parcours')
        db.rename_table('o_b_difficulte', 'classement_difficulte')
        db.rename_table('o_t_web', 'liens_web')
        db.rename_table('o_b_web_category', 'o_t_web_category')
        db.rename_table('o_b_theme', 'trekking_theme')
        db.rename_table('o_t_poi', 'trekking_poi')
        db.rename_table('o_b_poi', 'trekking_poitype')
