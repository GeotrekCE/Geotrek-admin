...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InformationDeskType'
        db.create_table('o_b_type_renseignement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pictogram', self.gf('django.db.models.fields.files.FileField')(max_length=512, null=True, db_column='picto')),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=128, db_column='label')),
        ))
        db.send_create_signal(u'trekking', ['InformationDeskType'])

        # Adding field 'InformationDesk.type'
        db.add_column('o_b_renseignement', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='desks', null=True, db_column='type', to=orm['trekking.InformationDeskType']),
                      keep_default=False)

        # Add default information desk type
        infotype, created = orm.InformationDeskType.objects.get_or_create(label="Information Point")
        if created:
            infotype.pictogram.name = 'upload/desktype-info.svg'
            infotype.save()

        for desk in orm.InformationDesk.objects.all():
            desk.type = infotype
            desk.save()

    def backwards(self, orm):
        # Deleting model 'InformationDeskType'
        db.delete_table('o_b_type_renseignement')

        # Deleting field 'InformationDesk.type'
        db.delete_column('o_b_renseignement', 'type')
    ...
    models = {
        ...
        u'trekking.informationdesk': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'desks'", 'null': 'True', 'db_column': "'type'", 'to': u"orm['trekking.InformationDeskType']"}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '256', 'null': 'True', 'db_column': "'website'", 'blank': 'True'})
        },
        u'trekking.informationdesktype': {
