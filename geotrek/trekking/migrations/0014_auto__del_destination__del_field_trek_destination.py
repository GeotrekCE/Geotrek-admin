...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Trek.destination'
        db.delete_column('itineraire', 'destination_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Trek.destination'
        db.add_column('itineraire', 'destination',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='treks', null=True, to=orm['trekking.Destination'], blank=True),
                      keep_default=False)
