...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('o_b_renseignement', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, db_column='telephone', blank=True),
                      keep_default=False)

        # Adding field 'InformationDesk.email'
        db.add_column('o_b_renseignement', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=256, null=True, db_column='email', blank=True),
                      keep_default=False)

        # Adding field 'InformationDesk.website'
        db.add_column('o_b_renseignement', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=256, null=True, db_column='website', blank=True),
                      keep_default=False)

        # Adding field 'InformationDesk.photo'
        db.add_column('o_b_renseignement', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=512, null=True, db_column='photo', blank=True),
                      keep_default=False)

        # Adding field 'InformationDesk.street'
        db.add_column('o_b_renseignement', 'street',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_column='rue', blank=True),
                      keep_default=False)

        # Adding field 'InformationDesk.postal_code'
        db.add_column('o_b_renseignement', 'postal_code',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_column='code', blank=True),
                      keep_default=False)

        # Adding field 'InformationDesk.municipality'
        db.add_column('o_b_renseignement', 'municipality',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_column='commune', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InformationDesk.email'
        db.delete_column('o_b_renseignement', 'email')

        # Deleting field 'InformationDesk.website'
        db.delete_column('o_b_renseignement', 'website')

        # Deleting field 'InformationDesk.photo'
        db.delete_column('o_b_renseignement', 'photo')

        # Deleting field 'InformationDesk.street'
        db.delete_column('o_b_renseignement', 'rue')

        # Deleting field 'InformationDesk.postal_code'
        db.delete_column('o_b_renseignement', 'code')

        # Deleting field 'InformationDesk.municipality'
        db.delete_column('o_b_renseignement', 'commune')
