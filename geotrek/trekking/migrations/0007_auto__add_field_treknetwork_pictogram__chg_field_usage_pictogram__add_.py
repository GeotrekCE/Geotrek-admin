...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrekNetwork.pictogram'
        db.add_column('o_b_reseau', 'pictogram',
        ...
        db.alter_column('o_b_web_category', 'picto', self.gf('django.db.models.fields.files.FileField')(max_length=512, null=True, db_column='picto'))

        # Changing field 'POIType.pictogram'
        db.alter_column('o_b_poi', 'picto', self.gf('django.db.models.fields.files.FileField')(max_length=512, null=True, db_column='picto'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WebLinkCategory.pictogram'
        db.alter_column('o_b_web_category', 'picto', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=512, db_column='picto'))

        # Changing field 'POIType.pictogram'
        db.alter_column('o_b_poi', 'picto', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=512, db_column='picto'))
