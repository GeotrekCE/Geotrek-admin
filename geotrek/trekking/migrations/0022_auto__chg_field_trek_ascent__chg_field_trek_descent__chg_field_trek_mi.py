...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Trek.ascent' to match new field type.
        db.rename_column('itineraire', 'ascent', 'denivelee_positive')
        # Changing field 'Trek.ascent'
        db.alter_column('itineraire', 'denivelee_positive', self.gf('django.db.models.fields.IntegerField')(db_column='denivelee_positive'))

        # Renaming column for 'Trek.descent' to match new field type.
        db.rename_column('itineraire', 'descent', 'denivelee_negative')
        # Changing field 'Trek.descent'
        db.alter_column('itineraire', 'denivelee_negative', self.gf('django.db.models.fields.IntegerField')(db_column='denivelee_negative'))

        # Renaming column for 'Trek.min_elevation' to match new field type.
        db.rename_column('itineraire', 'min_elevation', 'altitude_minimum')
        # Changing field 'Trek.min_elevation'
        db.alter_column('itineraire', 'altitude_minimum', self.gf('django.db.models.fields.IntegerField')(db_column='altitude_minimum'))

        # Renaming column for 'Trek.max_elevation' to match new field type.
        db.rename_column('itineraire', 'max_elevation', 'altitude_maximum')
        # Changing field 'Trek.max_elevation'
        db.alter_column('itineraire', 'altitude_maximum', self.gf('django.db.models.fields.IntegerField')(db_column='altitude_maximum'))

    def backwards(self, orm):

        # Renaming column for 'Trek.ascent' to match new field type.
        db.rename_column('itineraire', 'denivelee_positive', 'ascent')
        # Changing field 'Trek.ascent'
        db.alter_column('itineraire', 'ascent', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Trek.descent' to match new field type.
        db.rename_column('itineraire', 'denivelee_negative', 'descent')
        # Changing field 'Trek.descent'
        db.alter_column('itineraire', 'descent', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Trek.min_elevation' to match new field type.
        db.rename_column('itineraire', 'altitude_minimum', 'min_elevation')
        # Changing field 'Trek.min_elevation'
        db.alter_column('itineraire', 'min_elevation', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Trek.max_elevation' to match new field type.
        db.rename_column('itineraire', 'altitude_maximum', 'max_elevation')
        # Changing field 'Trek.max_elevation'
        db.alter_column('itineraire', 'max_elevation', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'trekking.trek': {
            ...
            'advice': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'advised_parking': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'ambiance': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'arrival': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            ...
            'ascent': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_column': "'denivelee_positive'"}),
            'departure': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            ...
            'description_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_it': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_teaser': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'name_fr': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'name_it': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'networks': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'treks'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['trekking.TrekNetwork']"}),
            'parking_location': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '%s' % settings.SRID, 'null': 'True', 'spatial_index': 'False', 'blank': 'True'}),
            'public_transport': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'themes': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'treks'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['trekking.Theme']"}),
            'topology_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Topology']", 'unique': 'True', 'primary_key': 'True'}),
            'usages': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'treks'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['trekking.Usage']"}),
            'web_links': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'treks'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['trekking.WebLink']"})
        },
        ...
        'trekking.weblink': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'links'", 'null': 'True', 'to': "orm['trekking.WebLinkCategory']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'trekking.weblinkcategory': {
            'Meta': {'object_name': 'WebLinkCategory', 'db_table': "'o_t_web_category'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'label_en': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'label_fr': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
