...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('o_b_renseignement', 'code', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, db_column='code'))
        db.execute("""UPDATE o_b_renseignement SET code = lpad(code_old::varchar(16), 5, '0')""")
