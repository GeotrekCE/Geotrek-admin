...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('itineraire', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Trek.parking_location'
        db.alter_column('itineraire', 'parking_location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=settings.SRID, null=True, spatial_index=False))

    def backwards(self, orm):

        # Changing field 'Trek.duration'
        db.alter_column('itineraire', 'duration', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Trek.parking_location'
        db.alter_column('itineraire', 'parking_location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=settings.SRID, default='POINT(0,0)', spatial_index=False))
