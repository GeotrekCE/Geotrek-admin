...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CirkwiPOICategory'
        db.create_table('o_b_cirkwi_poi_category', (
        ...
        db.send_create_signal(u'trekking', ['CirkwiPOICategory'])

        # Adding model 'CirkwiLocomotion'
        db.create_table('o_b_cirkwi_locomotion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('eid', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, db_column='nom')),
        ))
        db.send_create_signal(u'trekking', ['CirkwiLocomotion'])

        # Adding field 'Accessibility.cirkwi'
        db.add_column('o_b_accessibilite', 'cirkwi',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.CirkwiTag'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Practice.cirkwi'
        db.add_column('o_b_pratique', 'cirkwi',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trekking.CirkwiLocomotion'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DifficultyLevel.cirkwi_level'
        db.add_column('o_b_difficulte', 'cirkwi_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_column='niveau_cirkwi', blank=True),
                      keep_default=False)

        # Adding field 'DifficultyLevel.cirkwi'
        db.add_column('o_b_difficulte', 'cirkwi',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.CirkwiTag'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'POIType.cirkwi'
        db.add_column('o_b_poi', 'cirkwi',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trekking.CirkwiPOICategory'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'CirkwiPOICategory'
        db.delete_table('o_b_cirkwi_poi_category')

        # Deleting model 'CirkwiLocomotion'
        db.delete_table('o_b_cirkwi_locomotion')

        # Deleting field 'Accessibility.cirkwi'
        db.delete_column('o_b_accessibilite', 'cirkwi_id')

        # Deleting field 'Practice.cirkwi'
        db.delete_column('o_b_pratique', 'cirkwi_id')

        # Deleting field 'DifficultyLevel.cirkwi_level'
        db.delete_column('o_b_difficulte', 'niveau_cirkwi')

        # Deleting field 'DifficultyLevel.cirkwi'
        db.delete_column('o_b_difficulte', 'cirkwi_id')

        # Deleting field 'POIType.cirkwi'
        db.delete_column('o_b_poi', 'cirkwi_id')
    ...
    models = {
        ...
        u'trekking.poitype': {
            ...
            'cirkwi': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trekking.CirkwiPOICategory']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'trekking.practice': {
            ...
            'cirkwi': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trekking.CirkwiLocomotion']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'db_column': "'nom'"}),
            'pictogram': ('django.db.models.fields.files.FileField', [], {'max_length': '512', 'null': 'True', 'db_column': "'picto'"})
        },
