...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.practice'
        db.add_column('o_t_itineraire', 'practice',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trekking.Usage'], null=True, db_column='pratique', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trek.practice'
        db.delete_column('o_t_itineraire', 'pratique')
    ...
    models = {
        ...
        u'trekking.trek': {
            ...
            'practice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trekking.Usage']", 'null': 'True', 'db_column': "'pratique'", 'blank': 'True'}),
