...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Accessibility'
        db.create_table('o_b_accessibilite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, db_column='nom')),
        ))
        db.send_create_signal(u'trekking', ['Accessibility'])

        # Adding M2M table for field accessibilities on 'Trek'
        m2m_table_name = 'o_r_itineraire_accessibilite'
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trek', models.ForeignKey(orm[u'trekking.trek'], null=False)),
            ('accessibility', models.ForeignKey(orm[u'trekking.accessibility'], null=False))
        ))
        db.create_unique(m2m_table_name, ['trek_id', 'accessibility_id'])

    def backwards(self, orm):
        # Deleting model 'Accessibility'
        db.delete_table('o_b_accessibilite')

        # Removing M2M table for field accessibilities on 'Trek'
        db.delete_table('o_r_itineraire_accessibilite')
