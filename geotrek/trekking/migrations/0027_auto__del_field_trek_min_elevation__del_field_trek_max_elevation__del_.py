...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Trek.min_elevation'
        db.delete_column('o_t_itineraire', 'altitude_minimum')

        # Deleting field 'Trek.max_elevation'
        db.delete_column('o_t_itineraire', 'altitude_maximum')

        # Deleting field 'Trek.ascent'
        db.delete_column('o_t_itineraire', 'denivelee_positive')

        # Deleting field 'Trek.descent'
        db.delete_column('o_t_itineraire', 'denivelee_negative')


    def backwards(self, orm):
        # Adding field 'Trek.min_elevation'
        db.add_column('o_t_itineraire', 'min_elevation',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='altitude_minimum'),
                      keep_default=False)

        # Adding field 'Trek.max_elevation'
        db.add_column('o_t_itineraire', 'max_elevation',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='altitude_maximum'),
                      keep_default=False)

        # Adding field 'Trek.ascent'
        db.add_column('o_t_itineraire', 'ascent',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='denivelee_positive'),
                      keep_default=False)

        # Adding field 'Trek.descent'
        db.add_column('o_t_itineraire', 'descent',
    ...
    models = {
        ...
        'trekking.trek': {
            ...
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'db_column': "'duree'", 'blank': 'True'}),
            ...
            'related_treks': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_treks+'", 'symmetrical': 'False', 'through': "orm['trekking.TrekRelationship']", 'to': "orm['trekking.Trek']"}),
