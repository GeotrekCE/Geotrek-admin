...
from geotrek.trekking.models import Service, ServiceType, Trek
...
class Migration(DataMigration):
    ...
    models = {
        ...
        u'tourism.informationdesktype': {
            ...
            'label_en': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'label'", 'blank': 'True'}),
            'label_es': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'label'", 'blank': 'True'}),
            'label_fr': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'label'", 'blank': 'True'}),
            'label_it': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'label'", 'blank': 'True'}),
            'pictogram': ('django.db.models.fields.files.FileField', [], {'max_length': '512', 'null': 'True', 'db_column': "'picto'"})
        },
        ...
        u'trekking.poi': {
            ...
            'published_en': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'published_es': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'published_fr': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'published_it': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
        ...
        u'trekking.trek': {
            ...
            'advised_parking_en': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'parking'", 'blank': 'True'}),
            'advised_parking_es': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'parking'", 'blank': 'True'}),
            'advised_parking_fr': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'parking'", 'blank': 'True'}),
            'advised_parking_it': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'db_column': "'parking'", 'blank': 'True'}),
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'db_column': "'parent'", 'to': u"orm['trekking.Trek']"}),
            ...
            'public_transport_en': ('django.db.models.fields.TextField', [], {'null': 'True', 'db_column': "'transport'", 'blank': 'True'}),
            'public_transport_es': ('django.db.models.fields.TextField', [], {'null': 'True', 'db_column': "'transport'", 'blank': 'True'}),
            'public_transport_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'db_column': "'transport'", 'blank': 'True'}),
            'public_transport_it': ('django.db.models.fields.TextField', [], {'null': 'True', 'db_column': "'transport'", 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'db_column': "'date_publication'", 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'published_en': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'published_es': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            ...
            'source': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'treks'", 'to': u"orm['common.RecordSource']", 'db_table': "'o_r_itineraire_source'", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authent.Structure']", 'db_column': "'structure'"}),
