    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "route",
                    models.CharField(
                        max_length=128, verbose_name="Name", db_column="parcours"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "network",
                    models.CharField(
                        max_length=128, verbose_name="Name", db_column="reseau"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        verbose_name="Common departure",
                        db_column="depart_commun",
                    ),
                ),
                (
                    "has_common_edge",
                    models.BooleanField(
                        default=False,
                        verbose_name="Common edge",
                        db_column="troncons_communs",
                    ),
                ),
                (
                    "is_circuit_step",
                    models.BooleanField(
                        default=False,
                        verbose_name="Circuit step",
                        db_column="etape_circuit",
                    ),
                ),
                (
                    "trek_a",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        max_length=2048, verbose_name="URL", db_column="url"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                related_name="_trek_related_treks_+",
