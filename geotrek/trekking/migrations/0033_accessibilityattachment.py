# Generated by Django 3.1.14 on 2022-01-28 13:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment_accessibility_file', models.ImageField(blank=True, max_length=512, upload_to=paperclip.models.attachment_upload, verbose_name='Image')),
                ('info_accessibility', models.CharField(choices=[('slope', 'Slope'), ('width', 'Width'), ('signage', 'Signage')], default='slope', max_length=7, verbose_name='Information accessibility')),
                ...
                ('creator', models.ForeignKey(help_text='User that uploaded', on_delete=django.db.models.deletion.CASCADE, related_name='created_attachments_accessibility', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
            ],
            options={
