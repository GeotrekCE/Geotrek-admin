...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field source on 'Trek'
        m2m_table_name = 'o_r_itineraire_source'
        ...
        db.create_unique(m2m_table_name, ['trek_id', 'recordsource_id'])

    def backwards(self, orm):
        # Adding field 'Trek.source'
        db.add_column('o_t_itineraire', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='treks', null=True, to=orm['common.RecordSource'], db_column='source', blank=True),
                      keep_default=False)

        # Removing M2M table for field source on 'Trek'
        db.delete_table('o_r_itineraire_source')
