...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.points_reference'
        db.add_column('o_t_itineraire', 'points_reference',
                      self.gf('django.contrib.gis.db.models.fields.MultiPointField')(srid=settings.SRID, null=True, spatial_index=False, db_column='geom_points_reference', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trek.points_reference'
        db.delete_column('o_t_itineraire', 'geom_points_reference')
    ...
    models = {
        ...
        u'trekking.trek': {
            ...
            'points_reference': ('django.contrib.gis.db.models.fields.MultiPointField', [], {'srid': '%s' % settings.SRID, 'null': 'True', 'spatial_index': 'False', 'db_column': "'geom_points_reference'", 'blank': 'True'}),
