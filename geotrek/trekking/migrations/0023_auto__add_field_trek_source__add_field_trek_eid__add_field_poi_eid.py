...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.source'
        db.add_column('o_t_itineraire', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='treks', null=True, db_column='source', to=orm['common.RecordSource']),
                      keep_default=False)

        # Adding field 'Trek.eid'
        db.add_column('o_t_itineraire', 'eid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe', blank=True),
                      keep_default=False)

        # Adding field 'POI.eid'
        db.add_column('o_t_poi', 'eid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trek.source'
        db.delete_column('o_t_itineraire', 'source')

        # Deleting field 'Trek.eid'
        db.delete_column('o_t_itineraire', 'id_externe')

        # Deleting field 'POI.eid'
        db.delete_column('o_t_poi', 'id_externe')
    ...
    models = {
        ...
        u'trekking.trek': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'treks'", 'null': 'True', 'db_column': "'source'", 'to': u"orm['common.RecordSource']"}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authent.Structure']", 'db_column': "'structure'"}),
