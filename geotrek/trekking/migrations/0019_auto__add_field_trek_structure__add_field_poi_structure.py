...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trek.structure'
        db.add_column('o_t_itineraire', 'structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authent.Structure'], db_column='structure', default=1),
                      keep_default=False)

        # Adding field 'POI.structure'
        db.add_column('o_t_poi', 'structure',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authent.Structure'], db_column='structure', default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Trek.structure'
        db.delete_column('o_t_itineraire', 'structure')

        # Deleting field 'POI.structure'
        db.delete_column('o_t_poi', 'structure')
