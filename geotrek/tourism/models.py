...
from geotrek.tourism.managers import (
    TouristicContentManager,
    TouristicContentType1Manager,
    TouristicContentType2Manager,
    TouristicContentTypeFilteringManager,
    TouristicEventManager,
)
...
class TouristicContentCategory(TimeStampedModelMixin, PictogramMixin):
    ...
    geometry_type = models.CharField(
        max_length=16,
        choices=GeometryTypeChoices.choices,
        default=GeometryTypeChoices.POINT,
    )
...
def log_cascade_deletion_from_touristiccontenttype_category(
...
class TouristicContent(
    ...
    def topology_touristic_contents(cls, topology, queryset=None):
        return intersecting(qs=queryset_or_model(queryset, cls), obj=topology).order_by(
...
Topology.add_property(
    "touristic_contents",
    TouristicContent.topology_touristic_contents,
...
TouristicContent.add_property(
    "touristic_contents",
    TouristicContent.tourism_touristic_contents,
    _("Touristic contents"),
)
TouristicContent.add_property(
    "published_touristic_contents",
...
TouristicContent.add_property(
    "infrastructures", Infrastructure.tourism_infrastructures, _("Infrastructures")
)
...
class TouristicEvent(
    ...
    organizers = models.ManyToManyField(
        "tourism.TouristicEventOrganizer",
    ...
    preparation_duration = models.FloatField(
        verbose_name=_("Preparation duration"),
        blank=True,
        null=True,
    ...
    intervention_duration = models.FloatField(
        verbose_name=_("Intervention duration"),
        blank=True,
        null=True,
        help_text=_("In hours (1.5 = 1 h 30, 24 = 1 day, 48 = 2 days)"),
        validators=[MinValueValidator(0)],
    ...
    place = models.ForeignKey(
        ...
        blank=True,
        help_text=_(
            "Select a place in the list or locate the event directly on the map"
        ),
    )
    id_prefix = "E"
...
Topology.add_property(
    "touristic_events", TouristicEvent.topology_touristic_events, _("Touristic events")
)
Topology.add_property(
    "published_touristic_events",
    TouristicEvent.topology_published_touristic_events,
    _("Published touristic events"),
)
TouristicContent.add_property(
    "touristic_events", TouristicEvent.tourism_touristic_events, _("Touristic events")
)
TouristicContent.add_property(
    "published_touristic_events",
