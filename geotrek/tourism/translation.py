...
translator.register(tourism_models.TouristicContentCategory, TouristicContentCategoryTO)
...
translator.register(tourism_models.TouristicContentType, TouristicContentTypeTO)
...
translator.register(tourism_models.TouristicContentType1, TouristicContentSubTypeTO)
translator.register(tourism_models.TouristicContentType2, TouristicContentSubTypeTO)
