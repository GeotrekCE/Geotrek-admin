...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristicContentCategory.type1_label'
        db.add_column('t_b_contenu_touristique', 'type1_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='label_type1', blank=True),
                      keep_default=False)

        # Adding field 'TouristicContentCategory.type2_label'
        db.add_column('t_b_contenu_touristique', 'type2_label',
