...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'tourism.touristiccontent': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'db_column': "'nom'"}),
            'portal': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'touristiccontents'", 'blank': 'True', 'db_table': "'t_r_contenu_touristique_portal'", 'to': u"orm['common.TargetPortal']"}),
            ...
            'source': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'touristiccontents'", 'blank': 'True', 'db_table': "'t_r_contenu_touristique_source'", 'to': u"orm['common.RecordSource']"}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authent.Structure']", 'db_column': "'structure'"}),
        ...
        u'tourism.touristicevent': {
            ...
            'portal': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'touristicevents'", 'blank': 'True', 'db_table': "'t_r_evenement_touristique_portal'", 'to': u"orm['common.TargetPortal']"}),
            'practical_info': ('django.db.models.fields.TextField', [], {'db_column': "'infos_pratiques'", 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'db_column': "'date_publication'", 'blank': 'True'}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'review': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'relecture'"}),
            'source': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'touristicevents'", 'blank': 'True', 'db_table': "'t_r_evenement_touristique_source'", 'to': u"orm['common.RecordSource']"}),
