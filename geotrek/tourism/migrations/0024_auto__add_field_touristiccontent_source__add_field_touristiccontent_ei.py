...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('t_t_contenu_touristique', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='touristiccontents', null=True, db_column='source', to=orm['common.RecordSource']),
                      keep_default=False)

        # Adding field 'TouristicContent.eid'
        db.add_column('t_t_contenu_touristique', 'eid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe', blank=True),
                      keep_default=False)

        # Adding field 'TouristicEvent.source'
        db.add_column('t_t_evenement_touristique', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='touristicevents', null=True, db_column='source', to=orm['common.RecordSource']),
                      keep_default=False)

        # Adding field 'TouristicEvent.eid'
        db.add_column('t_t_evenement_touristique', 'eid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TouristicContent.eid'
        db.delete_column('t_t_contenu_touristique', 'id_externe')

        # Deleting field 'TouristicEvent.source'
        db.delete_column('t_t_evenement_touristique', 'source')

        # Deleting field 'TouristicEvent.eid'
        db.delete_column('t_t_evenement_touristique', 'id_externe')
    ...
    models = {
        ...
        u'tourism.touristiccontent': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'touristiccontents'", 'null': 'True', 'db_column': "'source'", 'to': u"orm['common.RecordSource']"}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authent.Structure']", 'db_column': "'structure'"}),
        ...
        u'tourism.touristicevent': {
            ...
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'public'"}),
            'review': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'relecture'"}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'touristicevents'", 'null': 'True', 'db_column': "'source'", 'to': u"orm['common.RecordSource']"}),
