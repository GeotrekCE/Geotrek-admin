...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TouristicEvent.meeting_time'
        db.delete_column('t_t_evenement_touristique', 'heure_rdv')
        db.add_column('t_t_evenement_touristique', 'heure_rdv', self.gf('django.db.models.fields.TimeField')(null=True, db_column='heure_rdv'))

    def backwards(self, orm):

        # Changing field 'TouristicEvent.meeting_time'
        db.delete_column('t_t_evenement_touristique', 'heure_rdv')
        db.add_column('t_t_evenement_touristique', 'heure_rdv', self.gf('django.db.models.fields.CharField')(default='', max_length=64, db_column='heure_rdv'))
