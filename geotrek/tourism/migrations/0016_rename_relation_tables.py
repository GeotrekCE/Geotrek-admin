...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('t_t_contenu_touristique_type1', 't_r_contenu_touristique_type1')
        db.rename_table('t_t_contenu_touristique_type2', 't_r_contenu_touristique_type2')
        db.rename_table('t_b_contenu_touristique', 't_b_contenu_touristique_categorie')
        db.rename_table('o_r_contenu_touristique_theme', 't_r_contenu_touristique_theme')

        db.rename_table('o_r_evenement_touristique_theme', 't_r_evenement_touristique_theme')
        db.rename_table('o_b_evenement_touristique_usage', 't_b_evenement_touristique_usage')
        db.rename_table('o_b_evenement_touristique_public', 't_b_evenement_touristique_public')

        db.rename_table('o_b_renseignement', 't_b_renseignement')
        db.rename_table('o_b_type_renseignement', 't_b_type_renseignement')

    def backwards(self, orm):
        db.rename_table('t_r_contenu_touristique_type1', 't_t_contenu_touristique_type1')
        db.rename_table('t_r_contenu_touristique_type2', 't_t_contenu_touristique_type2')
        db.rename_table('t_b_contenu_touristique_categorie', 't_b_contenu_touristique')
        db.rename_table('t_r_contenu_touristique_theme', 'o_r_contenu_touristique_theme')

        db.rename_table('t_r_evenement_touristique_theme', 'o_r_evenement_touristique_theme')
        db.rename_table('t_b_evenement_touristique_usage', 'o_b_evenement_touristique_usage')
        db.rename_table('t_b_evenement_touristique_public', 'o_b_evenement_touristique_public')

        db.rename_table('t_b_renseignement', 'o_b_renseignement')
        db.rename_table('t_b_type_renseignement', 'o_b_type_renseignement')
    ...
    models = {
        ...
        u'tourism.touristiceventusage': {
            'Meta': {'ordering': "['usage']", 'object_name': 'TouristicEventUsage', 'db_table': "'t_b_evenement_touristique_usage'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
