...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristicContent.reservation_id'
        db.add_column('t_t_contenu_touristique', 'reservation_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_reservation', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TouristicContent.reservation_id'
        db.delete_column('t_t_contenu_touristique', 'id_reservation')
