...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristicContent.review'
        db.add_column('t_t_contenu_touristique', 'review',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column='relecture'),
                      keep_default=False)

        # Adding field 'TouristicEvent.review'
        db.add_column('t_t_evenement_touristique', 'review',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column='relecture'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TouristicContent.review'
        db.delete_column('t_t_contenu_touristique', 'relecture')

        # Deleting field 'TouristicEvent.review'
        db.delete_column('t_t_evenement_touristique', 'relecture')
