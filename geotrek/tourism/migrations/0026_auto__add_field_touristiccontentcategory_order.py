...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristicContentCategory.order'
        db.add_column('t_b_contenu_touristique_categorie', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_column='tri', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TouristicContentCategory.order'
        db.delete_column('t_b_contenu_touristique_categorie', 'tri')
