...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristicContentCategory.geometry_type'
        db.add_column('t_b_contenu_touristique_categorie', 'geometry_type',
                      self.gf('django.db.models.fields.CharField')(default='point', max_length=16, db_column='type_geometrie'),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TouristicContentCategory.geometry_type'
        db.delete_column('t_b_contenu_touristique_categorie', 'type_geometrie')
