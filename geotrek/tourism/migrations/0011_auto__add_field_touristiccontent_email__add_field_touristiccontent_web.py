...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TouristicContent.email'
        db.add_column('t_t_contenu_touristique', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=256, null=True, db_column='email', blank=True),
                      keep_default=False)

        # Adding field 'TouristicContent.website'
        db.add_column('t_t_contenu_touristique', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=256, null=True, db_column='website', blank=True),
                      keep_default=False)

        # Adding field 'TouristicEvent.email'
        db.add_column('t_t_evenement_touristique', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=256, null=True, db_column='email', blank=True),
                      keep_default=False)

        # Adding field 'TouristicEvent.website'
        db.add_column('t_t_evenement_touristique', 'website',
                      self.gf('django.db.models.fields.URLField')(max_length=256, null=True, db_column='website', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TouristicContent.email'
        db.delete_column('t_t_contenu_touristique', 'email')

        # Deleting field 'TouristicContent.website'
        db.delete_column('t_t_contenu_touristique', 'website')

        # Deleting field 'TouristicEvent.email'
        db.delete_column('t_t_evenement_touristique', 'email')

        # Deleting field 'TouristicEvent.website'
        db.delete_column('t_t_evenement_touristique', 'website')
