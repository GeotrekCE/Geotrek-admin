...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TouristicContent.eid'
        db.alter_column('t_t_contenu_touristique', 'id_externe', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='id_externe'))

        # Changing field 'TouristicEvent.eid'
        db.alter_column('t_t_evenement_touristique', 'id_externe', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='id_externe'))

    def backwards(self, orm):

        # Changing field 'TouristicContent.eid'
        db.alter_column('t_t_contenu_touristique', 'id_externe', self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe'))

        # Changing field 'TouristicEvent.eid'
        db.alter_column('t_t_evenement_touristique', 'id_externe', self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe'))
