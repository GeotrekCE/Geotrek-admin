...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('t_b_evenement_touristique_public')

        # Deleting field 'TouristicEvent.public'
        db.delete_column('t_t_evenement_touristique', 'public_vise')

        # Renaming column for 'TouristicEvent.target_audience' to match new field type.
        db.rename_column('t_t_evenement_touristique', 'public_vise_', 'public_vise')
        # Changing field 'TouristicEvent.target_audience'
        db.alter_column('t_t_evenement_touristique', 'public_vise', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='public_vise'))

    def backwards(self, orm):
        # Adding model 'TouristicEventPublic'
        db.create_table('t_b_evenement_touristique_public', (
        ...
        # Renaming column for 'TouristicEvent.target_audience' to match new field type.
        db.rename_column('t_t_evenement_touristique', 'public_vise', 'public_vise_')
        # Changing field 'TouristicEvent.target_audience'
        db.alter_column('t_t_evenement_touristique', 'public_vise_', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='public_vise_'))

        # Adding field 'TouristicEvent.public'
        db.add_column('t_t_evenement_touristique', 'public',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tourism.TouristicEventPublic'], null=True, db_column='public_vise', blank=True),
                      keep_default=False)
