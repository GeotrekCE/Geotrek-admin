...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformationDesk.type'
        db.alter_column('o_b_renseignement', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, db_column='type', to=orm['tourism.InformationDeskType']))

    def backwards(self, orm):

        # Changing field 'InformationDesk.type'
        db.alter_column('o_b_renseignement', 'type', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tourism.InformationDeskType'], db_column='type'))
