...
class CoreConfig(AppConfig):
    ...
    def ready(self):
        from .forms import PathForm, OnNetworkTrailForm, OffNetworkTrailForm
        ...
        def check_hidden_fields_settings(app_configs, **kwargs):
            ...
            errors.extend(OnNetworkTrailForm.check_fields_to_hide())
            errors.extend(OffNetworkTrailForm.check_fields_to_hide())
            return errors
