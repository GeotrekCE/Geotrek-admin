...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['contenttypes.ContentType'].objects.filter(app_label='core', model='datasource').update(name='Path source', model='pathsource')

    def backwards(self, orm):
        orm['contenttypes.ContentType'].objects.filter(app_label='core', model='pathsource').update(name='Datasource', model='datasource')
    ...
    complete_apps = ['contenttypes', 'auth', 'core']
    symmetrical = True
