...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Path.eid'
        db.alter_column('l_t_troncon', 'id_externe', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='id_externe'))

    def backwards(self, orm):

        # Changing field 'Path.eid'
        db.alter_column('l_t_troncon', 'id_externe', self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_column='id_externe'))
