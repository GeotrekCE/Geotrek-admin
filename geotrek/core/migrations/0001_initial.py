...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('troncons', (
            ...
            ('geom_cadastre', self.gf('django.contrib.gis.db.models.fields.LineStringField')(srid=settings.SRID, dim=3, null=True, spatial_index=False)),
        ...
        db.create_table('evenements', (
            ...
            ('geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=settings.SRID, dim=3, spatial_index=False)),
        ))
    ...
    models = {
        ...
        'core.topology': {
            ...
            'geom': ('django.contrib.gis.db.models.fields.GeometryField', [], {'srid': '%s' % settings.SRID, 'dim': '3', 'spatial_index': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
