...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PathAggregation.order'
        db.add_column('e_r_evenement_troncon', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='ordre'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PathAggregation.order'
        db.delete_column('e_r_evenement_troncon', 'ordre')
    ...
    models = {
        ...
        'core.pathaggregation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'db_column': "'ordre'"}),
