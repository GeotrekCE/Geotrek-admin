...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('l_b_source', 'l_b_source_troncon')
        # Changing field 'Path.datasource'
        db.alter_column('l_t_troncon', 'source', self.gf('django.db.models.fields.related.ForeignKey')(null=True, db_column='source', to=orm['core.PathSource']))

    def backwards(self, orm):
        # Changing field 'Path.datasource'
        db.alter_column('l_t_troncon', 'source', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Datasource'], db_column='source'))
        db.rename_table('l_b_source_troncon', 'l_b_source')
    ...
    models = {
        ...
        u'core.path': {
            ...
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'paths'", 'null': 'True', 'db_column': "'source'", 'to': u"orm['core.PathSource']"}),
