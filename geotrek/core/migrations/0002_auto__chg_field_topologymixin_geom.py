...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topology.geom'
        db.alter_column('evenements', 'geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=settings.SRID, dim=3, null=True, spatial_index=False))

    def backwards(self, orm):

        # Changing field 'Topology.geom'
        db.alter_column('evenements', 'geom', self.gf('django.contrib.gis.db.models.fields.GeometryField')(srid=settings.SRID, dim=3, default=GEOSGeometry('POINT Z EMPTY'), spatial_index=False))
