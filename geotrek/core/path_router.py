            ...
            BEGIN
                ...
                CREATE TEMPORARY TABLE temporary_edges_info AS
                    ...
                    SELECT
                        ...
                        source_id AS source,
                        target_id AS target,
                        ST_LengthSpheroid(edge_geom, 'SPHEROID["GRS_1980",6378137,298.257222101]') AS cost,
                        ST_LengthSpheroid(edge_geom, 'SPHEROID["GRS_1980",6378137,298.257222101]') AS reverse_cost,
