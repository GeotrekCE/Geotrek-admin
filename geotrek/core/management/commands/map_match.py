...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--output", default="map_matching_files/mapmatching.png",
                            help="Filename for the output visualization image (default: map_matching_files/mapmatching.png)")
