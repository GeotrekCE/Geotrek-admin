...
TouristicEvent.add_property('areas', lambda self: intersecting(RestrictedArea, self, distance=0),
                            _(u"Restricted areas"))
if 'geotrek.diving' in settings.INSTALLED_APPS:
    Dive.add_property('areas', lambda self: uniquify(intersecting(RestrictedArea, self, distance=0)), _(u"Restricted areas"))
...
if 'geotrek.diving' in settings.INSTALLED_APPS:
    Dive.add_property('cities', lambda self: uniquify(intersecting(City, self, distance=0)), _(u"Cities"))
...
if 'geotrek.diving' in settings.INSTALLED_APPS:
    Dive.add_property('districts', lambda self: uniquify(intersecting(District, self, distance=0)), _(u"Districts"))
