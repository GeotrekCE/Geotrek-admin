...
if settings.TREKKING_TOPOLOGY_ENABLED:
    ...
    Topology.add_property('areas', lambda self: uniquify(intersecting(RestrictedArea, self)), _(u"Restricted areas"))
...
if settings.TREKKING_TOPOLOGY_ENABLED:
    ...
    Topology.add_property('districts', lambda self: uniquify(intersecting(District, self)), _(u"Districts"))
