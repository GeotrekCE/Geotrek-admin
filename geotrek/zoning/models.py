...
if settings.TREKKING_TOPOLOGY_ENABLED:
    ...
    Topology.add_property('areas', lambda self: uniquify(intersecting(RestrictedArea, self)) if self.topology.is_point() else uniquify(map(attrgetter('restricted_area'), self.area_edges)),
                          _(u"Restricted areas"))
