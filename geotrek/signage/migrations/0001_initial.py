    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, db_column='code', max_length=250, null=True, verbose_name='Code')),
                ('printed_elevation', models.IntegerField(blank=True, db_column='altitude_imprimee', null=True, verbose_name='Printed Elevation')),
                ('manager', models.ForeignKey(db_column='gestionnaire', null=True, blank=True, on_delete=django.db.models.deletion.CASCADE, to='common.Organism', verbose_name='Manager')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.ForeignKey(blank=True, db_column='structure', default=settings.DEFAULT_STRUCTURE_PK, null=True, on_delete=django.db.models.deletion.CASCADE, to='authent.Structure', verbose_name='Related structure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.ForeignKey(blank=True, db_column='structure',
                                                default=settings.DEFAULT_STRUCTURE_PK, null=True,
        ...
        migrations.AddField(
            model_name='signage',
            name='sealing',
            field=models.ForeignKey(db_column='scellement', null=True, blank=True, on_delete=django.db.models.deletion.CASCADE, to='signage.Sealing', verbose_name='Sealing'),
        ),
        migrations.AddField(
            model_name='signage',
            name='structure',
        ...
        migrations.AddField(
            model_name='signage',
            name='type',
            field=models.ForeignKey(db_column='type', on_delete=django.db.models.deletion.CASCADE, to='signage.SignageType', verbose_name='Type'),
        ),
        migrations.CreateModel(
            name='Blade',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.IntegerField(db_column='numero', verbose_name='Blade Number')),
        ...
        migrations.AddField(
            model_name='blade',
            name='type',
            field=models.ForeignKey(db_column='type', on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.IntegerField(db_column='nombre', verbose_name='Number')),
                ('text', models.CharField(db_column='texte', max_length=1000, verbose_name='Text')),
                ('distance',
                 models.DecimalField(blank=True, db_column='distance', decimal_places=3, max_digits=8, null=True,
                                     verbose_name='Distance')),
                ('pictogram_name', models.CharField(blank=True, db_column='nom_pictogramme', max_length=250, null=True,
                                                    verbose_name='Pictogramm name')),
                ('time', models.DurationField(blank=True, db_column='temps', null=True, verbose_name='Temps')),
                ('blade', models.ForeignKey(db_column='lame', related_name='lines', on_delete=django.db.models.deletion.PROTECT, to='signage.Blade',
                                            verbose_name='Blade')),
                ('structure',
                 models.ForeignKey(db_column='structure', default=settings.DEFAULT_STRUCTURE_PK,
                                   on_delete=django.db.models.deletion.CASCADE, to='authent.Structure',
                                   verbose_name='Related structure')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='blade',
            name='color',
            field=models.ForeignKey(blank=True, db_column='couleur', null=True,
                                    on_delete=django.db.models.deletion.PROTECT, to='signage.Color'),
        ),
        migrations.AddField(
            model_name='blade',
            name='condition',
            field=models.ForeignKey(blank=True, db_column='etat', null=True,
        ...
        migrations.AddField(
            model_name='blade',
            name='direction',
            field=models.ForeignKey(db_column='direction', on_delete=django.db.models.deletion.PROTECT,
                                    to='signage.Direction', verbose_name='Direction'),
        ),
        migrations.AddField(
            model_name='blade',
            name='signage',
            field=models.ForeignKey(db_column='signaletique', on_delete=django.db.models.deletion.PROTECT,
                                    to='signage.Signage', verbose_name='Signage'),
        ),
        migrations.AddField(
            model_name='blade',
            name='structure',
            field=models.ForeignKey(db_column='structure', default=settings.DEFAULT_STRUCTURE_PK,
                                    on_delete=django.db.models.deletion.CASCADE, to='authent.Structure',
                                    verbose_name='Related structure'),
        ),
