...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--sealing-field', '-se', action='store', dest='sealing_field', help='Name of the field that will be mapped to the sealing field in Geotrek')
        ...
        parser.add_argument('--code-field', '-cd', action='store', dest='code_field', help='Name of the field that will be mapped to the Code field in Geotrek')
        parser.add_argument('--eid-field', '-eid', action='store', dest='eid_field', help='Name of the field that will be mapped to the External ID in Geotrek')
