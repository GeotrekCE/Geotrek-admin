...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterventionJob.cost'
        db.add_column('bib_fonctions', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default=1.0, db_column='cout_jour', decimal_places=2, max_digits=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterventionJob.cost'
        db.delete_column('bib_fonctions', 'cout_jour')
