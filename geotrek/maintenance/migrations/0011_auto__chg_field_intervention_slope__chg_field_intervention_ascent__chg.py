...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('m_t_intervention', 'pente', self.gf('django.db.models.fields.FloatField')(null=True, db_column='pente'))

        # Changing field 'Intervention.ascent'
        db.alter_column('m_t_intervention', 'denivelee_positive', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='denivelee_positive'))

        # Changing field 'Intervention.descent'
        db.alter_column('m_t_intervention', 'denivelee_negative', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='denivelee_negative'))

        # Changing field 'Intervention.length'
        db.alter_column('m_t_intervention', 'longueur', self.gf('django.db.models.fields.FloatField')(null=True, db_column='longueur'))

        # Changing field 'Intervention.max_elevation'
        db.alter_column('m_t_intervention', 'altitude_maximum', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='altitude_maximum'))

        # Changing field 'Intervention.min_elevation'
        db.alter_column('m_t_intervention', 'altitude_minimum', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='altitude_minimum'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Intervention.ascent'
        db.alter_column('m_t_intervention', 'denivelee_positive', self.gf('django.db.models.fields.IntegerField')(db_column='denivelee_positive'))

        # Changing field 'Intervention.descent'
        db.alter_column('m_t_intervention', 'denivelee_negative', self.gf('django.db.models.fields.IntegerField')(db_column='denivelee_negative'))

        # Changing field 'Intervention.length'
        db.alter_column('m_t_intervention', 'longueur', self.gf('django.db.models.fields.FloatField')(db_column='longueur'))

        # Changing field 'Intervention.max_elevation'
        db.alter_column('m_t_intervention', 'altitude_maximum', self.gf('django.db.models.fields.IntegerField')(db_column='altitude_maximum'))

        # Changing field 'Intervention.min_elevation'
        db.alter_column('m_t_intervention', 'altitude_minimum', self.gf('django.db.models.fields.IntegerField')(db_column='altitude_minimum'))
    ...
    models = {
        ...
        'maintenance.intervention': {
            ...
            'topology': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'interventions_set'", 'null': 'True', 'to': "orm['core.Topology']"}),
