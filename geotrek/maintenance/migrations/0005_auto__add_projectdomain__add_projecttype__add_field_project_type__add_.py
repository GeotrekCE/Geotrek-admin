...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bib_projet_domaine', (
        ...
        db.send_create_signal('maintenance', ['ProjectDomain'])

        # Adding model 'ProjectType'
        db.create_table('bib_projet_type', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('structure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authent.Structure'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('maintenance', ['ProjectType'])

        # Adding field 'Project.type'
        db.add_column('chantiers', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maintenance.ProjectType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.domain'
        db.add_column('chantiers', 'domain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['maintenance.ProjectDomain'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProjectDomain'
        db.delete_table('bib_projet_domaine')

        # Deleting model 'ProjectType'
        db.delete_table('bib_projet_type')

        # Deleting field 'Project.type'
        db.delete_column('chantiers', 'type_id')

        # Deleting field 'Project.domain'
        db.delete_column('chantiers', 'domain_id')
    ...
    models = {
        ...
        'maintenance.projectdomain': {
            'Meta': {'object_name': 'ProjectDomain', 'db_table': "'bib_projet_domaine'"},
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authent.Structure']"})
        },
        'maintenance.projecttype': {
            'Meta': {'object_name': 'ProjectType', 'db_table': "'bib_projet_type'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'structure': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['authent.Structure']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        }
