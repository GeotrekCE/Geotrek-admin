    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.ForeignKey(db_column='structure', default=settings.DEFAULT_STRUCTURE_PK, on_delete=django.db.models.deletion.CASCADE, to='authent.Structure', verbose_name='Related structure')),
