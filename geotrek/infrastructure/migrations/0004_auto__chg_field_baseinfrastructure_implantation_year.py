...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Renaming column for 'BaseInfrastructure.implantation_year' to match new field type.
        db.rename_column('a_t_amenagement', 'implantation_year', 'annee_implantation')
        # Changing field 'BaseInfrastructure.implantation_year'
        db.alter_column('a_t_amenagement', 'annee_implantation',
                        self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True,
                                                                                     db_column='annee_implantation'))

    def backwards(self, orm):
        # Renaming column for 'BaseInfrastructure.implantation_year' to match new field type.
        db.rename_column('a_t_amenagement', 'annee_implantation', 'implantation_year')
        # Changing field 'BaseInfrastructure.implantation_year'
        db.alter_column('a_t_amenagement', 'implantation_year',
                        self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'infrastructure.baseinfrastructure': {
            'Meta': {'object_name': 'BaseInfrastructure', 'db_table': "'a_t_amenagement'",
                     '_ormbases': [u'core.Topology']},
            'condition': ('django.db.models.fields.related.ForeignKey', [],
                          {'to': u"orm['infrastructure.InfrastructureCondition']", 'null': 'True',
                           'on_delete': 'models.PROTECT', 'db_column': "'etat'", 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'db_column': "'description'", 'blank': 'True'}),
            'implantation_year': ('django.db.models.fields.PositiveSmallIntegerField', [],
                                  {'null': 'True', 'db_column': "'annee_implantation'"}),
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [],
                     {'to': u"orm['infrastructure.InfrastructureType']", 'db_column': "'type'"})
        },
        ...
        u'infrastructure.infrastructuretype': {
            'Meta': {'ordering': "['label', 'type']", 'object_name': 'InfrastructureType',
