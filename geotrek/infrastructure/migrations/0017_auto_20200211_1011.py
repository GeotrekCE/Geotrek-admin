...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'ordering': ('label',), 'verbose_name': 'Infrastructure Condition', 'verbose_name_plural': 'Infrastructure Conditions'},
        ),
        ...
        migrations.AlterField(
            model_name='infrastructure',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='infrastructure.InfrastructureType', verbose_name='Type'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='infrastructuretype',
            name='type',
            field=models.CharField(choices=[('A', 'Building'), ('E', 'Facility')], max_length=1),
        ),
