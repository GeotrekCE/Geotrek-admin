        ...
        try:
            for layer in data_source:
                ...
                if (
                    ...
                    and field_infrastructure_type not in available_fields
                ) or (
                    not field_infrastructure_type and not options.get("type_default")
                ):
                    self.stdout.write(
                        self.style.ERROR(
                ...
                if (
                    ...
                    and field_infrastructure_category not in available_fields
                ) or (
                    not field_infrastructure_category
                    and not options.get("category_default")
                ):
                    self.stdout.write(
                        self.style.ERROR(
                    ...
                    self.stdout.write(
                        self.style.ERROR("Change your --category-field option")
                    )
                    break
                ...
                if (
                    ...
                    and field_condition_type not in available_fields
                ):
                    self.stdout.write(
                        self.style.ERROR(
                    ...
                    self.stdout.write(
                        self.style.ERROR("Change your --condition-field option")
                    )
                    break
                if (
                    field_structure_type
                    and field_structure_type not in available_fields
                ):
                    self.stdout.write(
                        self.style.ERROR(
                    ...
                    self.stdout.write(
                        self.style.ERROR("Change your --structure-field option")
                    )
                    break
                ...
                if field_description and field_description not in available_fields:
                    ...
                    self.stdout.write(
                        self.style.ERROR("Change your --description-field option")
                    )
                    break

                if (
                    field_implantation_year
                    and field_implantation_year not in available_fields
                ):
                    self.stdout.write(
                        self.style.ERROR(
                ...
                for feature in layer:
                    ...
                    category = (
                        feature.get(field_infrastructure_category)
                        if field_infrastructure_category in available_fields
                        else options.get("category_default")
                    )
                    ...
                    description = (
                        ...
                        else options.get("description_default")
                    )
                    year = (
                        int(feature.get(field_implantation_year))
                        if field_implantation_year in available_fields
                        and feature.get(field_implantation_year).isdigit()
                        else options.get("year_default")
                    )
                    eid = (
