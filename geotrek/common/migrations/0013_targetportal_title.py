...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='targetportal',
            name='description',
            field=models.TextField(default='', help_text='Description on Geotrek Rando', verbose_name='Description'),
        ),
        migrations.AddField(
            model_name='targetportal',
            name='facebook_id',
            field=models.CharField(blank=True, help_text='Facebook ID for Geotrek Rando', max_length=20, null=True,
                                   verbose_name='Facebook ID'),
        ),
        migrations.AddField(
            model_name='targetportal',
            name='facebook_image_height',
            field=models.IntegerField(default=200, help_text="Facebook image's height",
                                      verbose_name='Facebook image height'),
        ),
        migrations.AddField(
            model_name='targetportal',
            name='facebook_image_url',
            field=models.CharField(default='/images/logo-geotrek.png', help_text='Url of the facebook image url',
