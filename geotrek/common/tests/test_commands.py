...
class CommandUnsetStructureTests(TestCase):
    def test_command_unset_structure(self):
        ...
        infratype1 = InfrastructureTypeFactory.create(
            label="annyeong", structure=structure1, pictogram=None
        )
        infratype2 = InfrastructureTypeFactory.create(
            label="annyeong", structure=structure2, pictogram=None
        )
        ...
        infrastructure1 = InfrastructureFactory.create(
            name="pissenlit", type=infratype1
        )
        infrastructure2 = InfrastructureFactory.create(
            name="rhododendron", type=infratype2
        )
    ...
    def test_unset_structure_fail_no_model_not_all(self):
        InfrastructureTypeFactory.create(
            label="annyeong", structure=None, pictogram=None
        )
