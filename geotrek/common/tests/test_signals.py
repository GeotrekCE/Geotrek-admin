...
class CommonSignalsTestCase(TestCase):
    ...
    def test_date_update_when_attachment_added(self):
        ...
        self.assertEqual(
            self.object.date_update.isoformat(), "2022-07-04T14:00:00+00:00"
        )
    ...
    def test_date_update_when_attachment_updated(self):
        ...
        # object date_update has been updated with current datetime
        self.assertEqual(
            self.object.date_update.isoformat(), "2022-07-04T15:00:00+00:00"
        )
    ...
    def test_date_update_when_hdviewpoint_updated(self):
        ...
        # object date_update has been updated with current datetime
        self.assertEqual(
            self.object.date_update.isoformat(), "2022-07-04T16:00:00+00:00"
        )
    ...
    def test_date_update_when_hdviewpoint_deleted(self):
        ...
        # object date_update has been updated with current datetime
        self.assertEqual(
            self.object.date_update.isoformat(), "2022-07-04T17:00:00+00:00"
        )
