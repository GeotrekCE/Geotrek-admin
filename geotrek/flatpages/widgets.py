...
FLATPAGE_TINYMCE_CONFIG = {
    ...
    "formats": {"informationFormat": {"block": "div", "classes": "information"}},
    "style_formats": [
        {
            "title": "Headings",
            "items": [
...
class FlatPageTinyMCE(AdminTinyMCE):
    def __init__(self, *args, **kwargs):
        ...
        mce_attrs["content_css"] = static(
            "flatpages/tinymce/css/flatpage_custom_formats.css"
        )
    ...
    class Media:
        ...
        css = {"all": ("flatpages/tinymce/css/flatpagetinymce_widget.css",)}
