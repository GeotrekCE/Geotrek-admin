    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_type',
                 models.CharField(blank=True, choices=[('page', 'Page'), ('link', 'Link')], max_length=10, null=True)),
                ('link_url', models.CharField(max_length=200, blank=True, default='', verbose_name='Link URL')),
                ('platform',
