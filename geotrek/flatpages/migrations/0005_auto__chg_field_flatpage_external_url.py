...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Remove null from url_externe field
        db.alter_column('p_t_page', 'url_externe', self.gf('django.db.models.fields.URLField')(max_length=200, db_column='url_externe'))

    def backwards(self, orm):
        # Restore null on url_externe field
