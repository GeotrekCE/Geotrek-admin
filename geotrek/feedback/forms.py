...
class ReportForm(CommonForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if (
            ...
            and settings.SURICATE_REPORT_ENABLED
    ...
    def save(self, *args, **kwargs):
        ...
        if (not creation) and settings.SURICATE_WORKFLOW_ENABLED:
            ...
            if (self.old_status.identifier in ["filed"]
            ...
            if (
                ...
                and not (self.old_status.identifier in ["waiting"]
                and report.status.identifier in ["waiting"])
            ):
            ...
            and (creation or self.old_status != report.status)
