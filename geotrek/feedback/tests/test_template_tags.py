...
class TestFeedbackTemplateTags(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.solved_status = ReportStatusFactory(
            identifier="solved_intervention", color="#448654"
        )
        cls.intervention_solved_1 = ReportInterventionFactory(
        ...
        cls.report_1.save()
        cls.intervention_solved_2 = ReportInterventionFactory(
            begin_date=datetime(year=1997, month=11, day=10).date(),
            end_date=datetime(year=1997, month=11, day=11).date(),
        )
        # Simulate user created intervention
