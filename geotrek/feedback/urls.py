...
from .views import CategoryList, FeedbackOptionsView, ReportFilesView, ReportWithPicturesView
...
urlpatterns = [
    ...
    path('api/<lang:lang>/reports/upload/<str:filename>', ReportFilesView.as_view(), name="report_attachment"),
]
