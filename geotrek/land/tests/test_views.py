...
class LandEdgeViewsTest(CommonTest):
    ...
    expected_json_geom = {
        "coordinates": [[3.0013501, 46.5008686], [3.0000461, 46.4999682]],
        "type": "LineString",
    }
...
class CirculationEdgeViewsTest(CommonTest):
    ...
    expected_json_geom = {
        "coordinates": [[2.9998617, 46.5000955], [3.0011657, 46.500996]],
        "type": "LineString",
    }
...
class CompetenceEdgeViewsTest(CommonTest):
    ...
    expected_json_geom = {
        "coordinates": [[2.9999539, 46.5000318], [3.0012579, 46.5009323]],
        "type": "LineString",
    }
...
class WorkManagementEdgeViewsTest(CommonTest):
    ...
    expected_column_formatlist_extra = ["id", "organization", "eid"]
    expected_json_geom = {
        "coordinates": [[2.9999078, 46.5000637], [3.0012118, 46.5009641]],
        "type": "LineString",
    }
...
class SignageManagementEdgeViewsTest(CommonTest):
    ...
    expected_column_formatlist_extra = ["id", "organization", "eid"]
    expected_json_geom = {
        "coordinates": [[3.0013962, 46.5008368], [3.0000922, 46.4999363]],
        "type": "LineString",
    }
