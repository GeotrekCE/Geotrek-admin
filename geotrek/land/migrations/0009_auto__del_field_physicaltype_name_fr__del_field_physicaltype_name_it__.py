...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        try:
            ...
            db.delete_column('f_b_nature', 'name_fr')

            # Deleting field 'PhysicalType.name_it'
            db.delete_column('f_b_nature', 'name_it')
    ...
    def backwards(self, orm):
        ...
        db.add_column('f_b_nature', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='nom', blank=True),
                      keep_default=False)

        # Adding field 'PhysicalType.name_it'
        db.add_column('f_b_nature', 'name_it',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='nom', blank=True),
                      keep_default=False)

        # Adding field 'PhysicalType.name_en'
        db.add_column('f_b_nature', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, db_column='nom', blank=True),
                      keep_default=False)
