...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RestrictedArea.order'
        db.delete_column('couche_zonage_reglementaire', 'order')


    def backwards(self, orm):
        # Adding field 'RestrictedArea.order'
        db.add_column('couche_zonage_reglementaire', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=None, db_column='order'),
                      keep_default=False)
