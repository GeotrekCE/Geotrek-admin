...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Renaming column for 'LandEdge.owner' to match new field type.
        db.rename_column('f_t_foncier', 'owner', 'proprietaire')
        # Changing field 'LandEdge.owner'
        db.alter_column('f_t_foncier', 'proprietaire',
                        self.gf('django.db.models.fields.TextField')(db_column='proprietaire'))

        # Renaming column for 'LandEdge.agreement' to match new field type.
        db.rename_column('f_t_foncier', 'agreement', 'convention')
        # Changing field 'LandEdge.agreement'
        db.alter_column('f_t_foncier', 'convention',
                        self.gf('django.db.models.fields.BooleanField')(db_column='convention'))

    def backwards(self, orm):
        # Renaming column for 'LandEdge.owner' to match new field type.
        db.rename_column('f_t_foncier', 'proprietaire', 'owner')
        # Changing field 'LandEdge.owner'
        db.alter_column('f_t_foncier', 'owner', self.gf('django.db.models.fields.TextField')())

        # Renaming column for 'LandEdge.agreement' to match new field type.
        db.rename_column('f_t_foncier', 'convention', 'agreement')
        # Changing field 'LandEdge.agreement'
        db.alter_column('f_t_foncier', 'agreement', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'core.path': {
            ...
            'geom_3d': ('django.contrib.gis.db.models.fields.GeometryField', [],
                        {'default': 'None', 'dim': '3', 'spatial_index': 'False', 'null': 'True',
                         'srid': settings.SRID}),
        ...
        u'land.competenceedge': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [],
                             {'to': u"orm['common.Organism']", 'db_column': "'organisme'"}),
        ...
        u'land.landedge': {
            ...
            'agreement': (
            'django.db.models.fields.BooleanField', [], {'default': 'False', 'db_column': "'convention'"}),
            'land_type': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['land.LandType']", 'db_column': "'type'"}),
        ...
        u'land.physicaledge': {
            ...
            'physical_type': ('django.db.models.fields.related.ForeignKey', [],
                              {'to': u"orm['land.PhysicalType']", 'db_column': "'type'"}),
            'topo_object': ('django.db.models.fields.related.OneToOneField', [],
                            {'to': u"orm['core.Topology']", 'unique': 'True', 'primary_key': 'True',
                             'db_column': "'evenement'"})
        },
        ...
        u'land.signagemanagementedge': {
            'Meta': {'object_name': 'SignageManagementEdge', 'db_table': "'f_t_gestion_signaletique'",
        ...
        u'land.workmanagementedge': {
            'Meta': {'object_name': 'WorkManagementEdge', 'db_table': "'f_t_gestion_travaux'",
                     '_ormbases': [u'core.Topology']},
            'organization': ('django.db.models.fields.related.ForeignKey', [],
                             {'to': u"orm['common.Organism']", 'db_column': "'organisme'"}),
            'topo_object': ('django.db.models.fields.related.OneToOneField', [],
