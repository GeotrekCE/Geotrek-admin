CREATE VIEW {# geotrek.land #}.v_physicals AS (
...
CREATE VIEW {# geotrek.land #}.v_lands AS (
...
CREATE VIEW {# geotrek.land #}.v_competences AS (
...
CREATE VIEW {# geotrek.land #}.v_signagemanagements AS (
	SELECT e.*, b.structure_id, b.organism
...
CREATE VIEW {# geotrek.land #}.v_workmanagements AS (
	SELECT e.*, b.structure_id, b.organism
