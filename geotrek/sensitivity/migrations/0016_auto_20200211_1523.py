...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sensitivearea',
            name='species',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sensitivity.Species', verbose_name='Sensitive area'),
        ),
        migrations.AlterField(
            model_name='sensitivearea',
            name='structure',
        ...
        migrations.AlterField(
            model_name='species',
            name='category',
            field=models.IntegerField(choices=[(1, 'Species'), (2, 'Regulatory')], default=settings.DEFAULT_STRUCTURE_PK, editable=False, verbose_name='Category'),
        ),
        migrations.AlterField(
            model_name='species',
            name='eid',
        ...
        migrations.AlterField(
            model_name='species',
            name='practices',
            field=models.ManyToManyField(to='sensitivity.SportPractice', verbose_name='Sport practices'),
        ),
        migrations.AlterField(
            model_name='species',
            name='radius',
            field=models.IntegerField(blank=True, help_text='meters', null=True, verbose_name='Bubble radius'),
        ),
        migrations.AlterField(
