...
class BiodivParserTests(TestCase):
    ...
    def test_create(self, mocked):
        ...
        call_command(
            "import",
            "geotrek.sensitivity.tests.test_parsers.BiodivWithPracticeParser",
            verbosity=0,
        )
        ...
        self.assertQuerySetEqual(
            species.practices.all(), ["<SportPractice: Land>"], transform=repr
        )
    ...
    def test_status_code_404(self, mocked):
        ...
        with self.assertRaisesRegex(
            ...
            call_command(
                "import",
                "geotrek.sensitivity.tests.test_parsers.BiodivWithoutPracticeParser",
                verbosity=0,
            )
